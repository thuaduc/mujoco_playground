...
def parse_args():
    ...
    # Logging
    parser.add_argument("--num-evals", type=int, default=20, help="Number of evaluations during training")
    parser.add_argument("--num-videos", type=int, default=3, help="Number of videos to record after training")
